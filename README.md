...
You will also need to disable UART console login. To do so on RPi 4, delete `console=ttyAMA0,115200` from `/boot/firmware/nobtcmd.txt`. The content of the file should be something like:
